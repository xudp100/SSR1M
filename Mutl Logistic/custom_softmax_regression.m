classdef custom_softmax_regression
    ...
    methods
        function obj = custom_softmax_regression(x_train, y_train, x_test, y_test, num_class, varargin)
            ...
            obj.param_shape = [obj.d, obj.num_class];
        end
        ...
        function true_labels = train_true_labels(problem)
            true_labels = problem.y_train;
        end

        function true_labels = test_true_labels(problem)
            true_labels = problem.y_test;
        end
